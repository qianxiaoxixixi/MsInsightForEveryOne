...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_md5_distributed_multi_ranks/npu/step0
    bench_path=${cur_dir}/test_data/test_compare_md5_distributed_multi_ranks/cpu/step0

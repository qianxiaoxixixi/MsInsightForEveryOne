...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_exception/dump_json_dict_type/dump.json
    bench_path=${cur_dir}/test_data/test_compare_exception/dump_json_dict_type/dump.json
    stack_path=${cur_dir}/test_data/test_compare_exception/dump_json_dict_type/stack.json

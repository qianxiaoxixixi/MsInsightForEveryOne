...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_summary_default_fuzzy_on/msprobe_compare_0008_20250421_111218/step1/rank7/dump.json
    bench_path=${cur_dir}/test_data/test_compare_summary_default_fuzzy_on/msprobe_compare_0008_20250421_113904/step1/rank7/dump.json
    stack_path=${cur_dir}/test_data/test_compare_summary_default_fuzzy_on/msprobe_compare_0008_20250421_111218/step1/rank7/stack.json
    ...
    msprobe -f pytorch compare -i ${input_path} -o ${out_dump_path} -f -hl >> ${testcase_result_dir}/plog.txt
    end_time=$(date "+%s")
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_summary_default_fuzzy_on/out/advisor_*.txt | awk '{ print $1 }')
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_summary_default_fuzzy_on/out/compare_result_*.csv | awk '{ print $1 }')
    if [ "$md5_value" != "$md5_baseline" ]; then

...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_distributed_with_stack_json_llama2_7b/step0
    bench_path=${cur_dir}/test_data/test_compare_distributed_with_stack_json_llama2_7b/step0
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_distributed_with_stack_json_no_s_llama2_7b/out/compare_result_rank0_*.csv | awk '{ print $1 }')

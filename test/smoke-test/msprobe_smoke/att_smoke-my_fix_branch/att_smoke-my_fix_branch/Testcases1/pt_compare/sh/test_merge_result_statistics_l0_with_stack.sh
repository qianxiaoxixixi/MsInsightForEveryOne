...
main() {
    ...
    input_dir_path=${cur_dir}/test_data/test_merge_result_statistics_l0_with_stack
    output_dir_path=${testcase_result_dir}/out
    config_yaml_path=${cur_dir}/yaml/config_module.yaml
    ...
    baseline_xlsx_path=${cur_dir}/baseline/test_merge_result_statistics_l0_with_stack/out/multi_ranks_compare_merge_*.xlsx

...
main() {
    ...
    input_dir_path=${cur_dir}/test_data/test_merge_result_exception_api_data_not_found_in_rank1
    output_dir_path=${testcase_result_dir}/out
    config_yaml_path=${cur_dir}/yaml/config_api_data_not_found_in_rank1.yaml
    ...
    baseline_xlsx_path=${cur_dir}/baseline/test_merge_result_exception_api_data_not_found_in_rank1/out/multi_ranks_compare_merge_*.xlsx

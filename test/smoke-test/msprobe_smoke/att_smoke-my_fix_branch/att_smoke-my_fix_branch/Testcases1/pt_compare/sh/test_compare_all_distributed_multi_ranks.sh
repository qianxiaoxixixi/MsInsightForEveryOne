...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_all_distributed_multi_ranks/npu/step0
    bench_path=${cur_dir}/test_data/test_compare_all_distributed_multi_ranks/cpu/step0
    ...
    if [[ $(ls ${out_dump_path} | wc -w) !=  4 ]] || [[ ${result##*.} != "xlsx" ]]; then

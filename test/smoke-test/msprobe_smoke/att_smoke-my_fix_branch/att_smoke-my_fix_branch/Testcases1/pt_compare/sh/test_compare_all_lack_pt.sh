...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_all_mode_lack_pt/npu/step0/rank/dump.json
    bench_path=${cur_dir}/test_data/test_compare_all_mode_lack_pt/cpu/step0/rank/dump.json
    stack_path=${cur_dir}/test_data/test_compare_all_mode_lack_pt/npu/step0/rank/stack.json
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_all_lack_pt/out/advisor_*.txt | awk '{ print $1 }')
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_all_lack_pt/out/compare_result_*.csv | awk '{ print $1 }')
    if [ "$md5_value" != "$md5_baseline" ]; then

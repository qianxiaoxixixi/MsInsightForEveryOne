...
main() {
    ...
    input_dir_path=${cur_dir}/test_data/test_merge_result_statistics_no_stack
    ...
    baseline_xlsx_path=${cur_dir}/baseline/test_merge_result_statistics_no_stack/out/multi_ranks_compare_merge_*.xlsx

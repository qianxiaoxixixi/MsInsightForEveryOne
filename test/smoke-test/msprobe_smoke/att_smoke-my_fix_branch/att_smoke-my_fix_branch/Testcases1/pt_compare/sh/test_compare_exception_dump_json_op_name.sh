...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_exception/dump_json_op_name/dump.json
    bench_path=${cur_dir}/test_data/test_compare_exception/dump_json_op_name/dump.json
    stack_path=${cur_dir}/test_data/test_compare_exception/dump_json_op_name/stack.json

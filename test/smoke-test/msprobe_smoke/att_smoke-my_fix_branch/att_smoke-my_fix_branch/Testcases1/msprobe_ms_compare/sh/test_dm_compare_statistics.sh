...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_dm_compare_statistics/ms_data/step0/rank/dump.json
    bench_path=${cur_dir}/test_data/test_dm_compare_statistics/pt_data/step0/rank/dump.json
    stack_path=${cur_dir}/test_data/test_dm_compare_statistics/ms_data/step0/rank/stack.json
    ...
    dm_yaml_path=${cur_dir}/test_data/test_dm_compare_statistics/dm.yaml
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_dm_compare_statistics/out/compare_result_*.csv | awk '{ print $1 }')

...
main() {
    ...
    npu_path=${cur_dir}/test_data/test_compare_cell_summary_mode/step0/rank0/dump.json
    bench_path=${cur_dir}/test_data/test_compare_cell_summary_mode/step0/rank0/dump.json
    stack_path=${cur_dir}/test_data/test_compare_cell_summary_mode/step0/rank0/stack.json
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_cell_summary/out/advisor_*.txt | awk '{ print $1 }')
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare_cell_summary/out/compare_result_*.csv | awk '{ print $1 }')
    if [ "$md5_value" != "$md5_baseline" ]; then

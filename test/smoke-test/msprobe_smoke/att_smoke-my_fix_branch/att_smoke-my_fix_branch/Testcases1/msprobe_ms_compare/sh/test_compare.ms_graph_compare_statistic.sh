...
main() {
    ...
    npu_path=${cur_dir}/test_data/ms_graph_statistic_compare_data/dump_data0
    bench_path=${cur_dir}/test_data/ms_graph_statistic_compare_data/dump_data1


    input_path=${cur_dir}/json/compare_input_json/ms_graph_compare.json
    ...
    md5_baseline=$(md5sum ${cur_dir}/baseline/test_compare.ms_graph_compare_statistic/out/compare_result_0_0_*.csv | awk '{ print $1 }')

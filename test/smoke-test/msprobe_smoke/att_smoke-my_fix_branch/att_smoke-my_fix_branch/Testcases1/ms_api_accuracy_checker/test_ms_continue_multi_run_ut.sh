...
msprobe -f mindspore multi_run_ut -api_info ${dump_json_path} -o ${output_path} -csv_path ${output_path}/accuracy_checking_result_20241016152330.csv -d 4 5 6 7 >> ${log_file}

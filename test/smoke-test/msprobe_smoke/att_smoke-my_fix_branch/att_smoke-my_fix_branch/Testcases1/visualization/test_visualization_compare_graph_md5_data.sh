...
main() {
    ...
    msprobe -f pytorch graph -i ${cur_dir}/test_data/md5.json -o ${testcase_result_dir} >> ${testcase_result_dir}/plog.txt
    end_time=$(date "+%s")
    ...
    python3 ${cur_dir}/src/validate_visualization_compare_graph_md5.py ${vis_file} >> ${testcase_result_dir}/plog.txt

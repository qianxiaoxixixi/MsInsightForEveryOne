...
main() {
    ...
    msprobe -f pytorch graph -i ${cur_dir}/test_data/statistics.json -o ${testcase_result_dir} >> ${testcase_result_dir}/plog.txt
    end_time=$(date "+%s")
    ...
    python3 ${cur_dir}/src/validate_visualization_compare_graph_statistics.py ${vis_file} >> ${testcase_result_dir}/plog.txt

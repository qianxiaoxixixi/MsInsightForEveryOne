...
config_path=${cur_dir}/config/test_ms_acl_dump_tensor_output_bin.json
net_dir=${cur_dir}/src
net_path=${net_dir}/mnist_graph.py
...
main() {
    ...
    python ${cmp_path} ${cur_dir}/baseline/${file_name}/dump_data ${data_path} bin >> ${testcase_result_dir}/cmp_result.txt

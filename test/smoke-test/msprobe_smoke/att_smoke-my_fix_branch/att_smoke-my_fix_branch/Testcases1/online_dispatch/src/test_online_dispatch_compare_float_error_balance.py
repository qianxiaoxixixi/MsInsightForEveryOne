...
def compare(dump_path):
    ...
    npu_out_cpu_1 = torch.tensor([0.50009,0.50009],dtype=torch.float32)
    npu_out_cpu_2 = torch.tensor([0.50001,0.50001],dtype=torch.float32)
    cpu_out = torch.tensor([0.50001,0.50001],dtype=torch.float32)

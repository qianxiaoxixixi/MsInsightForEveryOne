...
def compare(dump_path):
    ...
    npu_out_cpu_1 = torch.tensor([99999,99998],dtype=torch.float32)
    npu_out_cpu_2 = torch.tensor([100000,100000],dtype=torch.float32)
    cpu_out = torch.tensor([100000,100000],dtype=torch.float32)

...
main() {
    ...
    bash examples/llama2/test_xy_forward_single_ops.sh  > ${testcase_result_dir}/plog.txt 2>&1
    # cd /home/maoyanlong/att_smoke_new/Model_msmonitor/Model/ModelLink
    # bash examples/llama2/test_xy.sh
    
    verify_csv_output 1

    # testcase_result_dir=/home/maoyanlong/att_smoke_new/WorkSpace1/output-16/msmonitor/test_xy
    
    expected_header="vpp_stage,name,step,micro_step,norm,shape,dtype"
    verify_csv_content ${testcase_result_dir}/*/actv_0-0.csv 3553 $expected_header

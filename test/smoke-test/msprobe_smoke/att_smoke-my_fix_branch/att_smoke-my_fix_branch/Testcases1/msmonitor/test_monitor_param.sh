...
main() {
    ...
    bash examples/llama2/test_param.sh  > ${testcase_result_dir}/plog.txt 2>&1

    verify_csv_output 4

    # testcase_result_dir=/home/maoyanlong/att_smoke_new/WorkSpace1/output-16/msmonitor/test_param
    expected_header="vpp_stage,name,step,norm,min,max,mean,nans,shape,dtype"
    verify_csv_content ${testcase_result_dir}/*/param_origin_1-1.csv 28 $expected_header
    verify_csv_content ${testcase_result_dir}/*/param_updated_1-1.csv 28 $expected_header

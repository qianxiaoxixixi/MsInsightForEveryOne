...
if __name__ == "__main__":
    ...
    ms.save_checkpoint(net, "alexnet.ckpt")
    grad_net = ms.value_and_grad(net, None, net.trainable_params(), return_ids=True)
    value, output = grad_net(ms.Tensor(np.random.normal(1, 1, (1, 3, 227, 227)).astype(np.float32)))
    # debugger.stop()

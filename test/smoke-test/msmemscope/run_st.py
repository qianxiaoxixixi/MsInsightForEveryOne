...
def run_tests(working_dir: str, params) -> bool:
    ...
    watch_aten_hash_cmd = ["../../msmemscope/output/bin/msmemscope", "python", "../../testfile/scripts/watch/watch_aten.py",
        "--watch=torch._ops.aten.mse_loss.default,torch._ops.aten.mse_loss_backward.default"]
    watch_aten_bin_cmd = ["../../msmemscope/output/bin/msmemscope", "python", "../../testfile/scripts/watch/watch_aten.py",

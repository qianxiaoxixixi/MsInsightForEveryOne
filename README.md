...
- 许可证 <br>
  MindStudio Insight工具的使用许可证，具体情参见[LICENSE](./License)。<br>MindStudio Insight工具docs目录下的文档适用CC-BY 4.0许可证，具体请参见[DOC LICENSE](./docs/LICENSE)。
...
华为MindStuido全流程开发工具链团队致力于提供端到端的昇腾AI应用开发解决方案，使能开发者高效完成训练开发、推理开发和算子开发。

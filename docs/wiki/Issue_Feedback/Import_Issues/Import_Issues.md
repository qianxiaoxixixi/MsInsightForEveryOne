...
![a2-collection-data.png](images/profiling-info-incomplete-1.png)
...
![a2-collection-data.png](images/profiling-info-incomplete-2.png)
...
![a2-collection-data.png](images/cannot-import-project.png)
...
![a2-collection-data.png](images/multi-card-no-summary-1.png)

![a2-collection-data.png](images/multi-card-no-summary-2.png)

![a2-collection-data.png](images/multi-card-no-summary-3.png)

![a2-collection-data.png](images/multi-card-no-summary-4.png)
...
![a2-collection-data.png](images/multi-card-msprof-result.png)

多卡的采集结果op_summary中存在NPU的算子信息，但是导入output文件后：

NPU无算子信息展示：

![a2-collection-data.png](images/multi-card-no-npu-operator.png)

只更改卡数，单卡采集后的结果就存在NPU算子信息：

![a2-collection-data.png](images/single-card-has-npu-operator.png)
...
![a2-collection-data.png](images/cache-db-issue.png)
...
![a2-collection-data.png](images/cluster-import-no-response.png)
...
![a2-collection-data.png](images/no-parsable-db-1.png)

![a2-collection-data.png](images/no-parsable-db-2.png)
...
![a2-collection-data.png](images/import-cannot-see-directory.png)
...
![a2-collection-data.png](images/path-security-check.png)
...
![a2-collection-data.png](images/nodata-3.png)
...
![a2-collection-data.png](images/nodata-4.png)

然后就一直转圈

![a2-collection-data.png](images/nodata-5.png)
...
![a2-collection-data.png](images/nodata-7.png)
...
![a2-collection-data.png](images/profiling-parsing-flow.png)
...
![a2-collection-data.png](images/msprof-db-import-1.png)

![a2-collection-data.png](images/msprof-db-import-2.png)
...
![a2-collection-data.png](images/cluster-communication-group-lost.png)

查看communication_group.json，原始确实包含大量的communication group

![a2-collection-data.png](images/communication-group-json.png)
...
![a2-collection-data.png](images/cluster-import-wrong-flow.png)

修改为以下正确流程即可：

![a2-collection-data.png](images/cluster-import-correct-flow.png)
...
![a2-collection-data.png](images/large-file-import-1.png)

![a2-collection-data.png](images/large-file-import-2.png)

![a2-collection-data.png](images/large-file-import-3.png)

...
![image-viewer](images/help-keyboard-shortcuts.gif)
...
**截图示例：**
![image-viewer](images/zoom-timeline.gif)
...
![image-viewer](images/pan-left-right.gif)
...
**截图示例：**
![image-viewer](images/undo-zoom-pan.gif)
...
**截图示例：**
![](images/collapse-bottom-panel.gif)

### 2. 框选功能

框选功能介绍：框选部分算子，可以在“底部面板-选中列表”中看到相应统计信息，点击“更多”可跳转至时间线具体算子位置。

![](images/selection-statistics.png)
...
**截图示例：**
![](images/zoom-selection-to-screen.gif)
...
**截图示例：**
![](images/toggle-selection-region.gif)
...
![](images/search-in-source-code.gif)

...
<tbody>
  ...
  <tr>
    <td>click</td>
    <td rowspan="13">MindStudio Insight已集成msprof-analyze集群分析工具所依赖的Python库。<br>版本要求见msprof-analyze工具的<a href="https://gitcode.com/Ascend/msprof-analyze/blob/26.0.0/requirements/build.txt" class="td-link">build.txt文件</a>。</td>
  </tr>
  <tr>
    <td>tabulate</td>
  </tr>

...
<table>
    ...
    <tr>
        <td>1</td>
        <td>支持PyTorch中snapshot内存分析</td>
        <td>支持snapshot中内存Timeline展示和内存状态分析功能</td>
        <td></td>  
    </tr>
    <tr>
        <td>2</td>
        <td>支持MindStudio Memory Scope内存分析</td>
        <td>支持msMemScope内存Timeline、调用栈、内存分类拆解等功能</td>
        <td></td>  
    </tr>
</table>

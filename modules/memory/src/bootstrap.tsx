...
import { disableShortcuts, errorCenter, type RequestOptions, WsError } from '@insight/lib/utils';
...
declare global {
    interface Window {
        ...
        request: (params: { command: string; params: Record<string, unknown> }, options?: RequestOptions) => Promise<any>;
...
window.request = async (params, options): Promise<any> => {
    try {

...
// 代表PTA-WORKSPACE
const std::string LEAKS_MEMORY_ALLOC_OWNER_PTA_WORKSPACE = "PTA_WORKSPACE";
const std::string LEAKS_MEMORY_ALLOC_OWNER_PTA_WORKSPACE_NAME = "PTA_Workspace";
// 缺省名
...
const std::unordered_map<std::string, std::string> LEAKS_MEMORY_ALLOC_OWNER_NAME_MAP = {
    ...
    {LEAKS_MEMORY_ALLOC_OWNER_PTA_WORKSPACE, LEAKS_MEMORY_ALLOC_OWNER_PTA_WORKSPACE_NAME}
};
// 树最大深度

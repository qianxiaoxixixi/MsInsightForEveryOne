...
void MemScopeService::ParseRemainMallocEvents(ParseContext &context)
{
...
void MemScopeService::ParseEventsToBlockAndAllocations(ParseContext &context)
{
...
void MemScopeService::SetMemoryBlockExtendByEventGroup(MemoryBlock& block, const uint64_t groupId,
                                                       ParseContext &context)
{

...
enum class ErrorCode {
    ...
    QUERY_EVENTS_VIEW_DATA_FAILED = 3102,
    QUERY_AI_CORE_FREQ_FAILED = 3103,
    ...
    QUERY_OVERALL_METRICS_DETAIL_FAILED = 3110,
    QUERY_SYSTEM_VIEW_FAILED = 3111,
    OVERLAP_ANALYSIS_PARSE_NOT_FINISH = 3112,
    QUERY_SYSTEM_VIEW_OVERALL_FAILED = 3113,

...
#ifndef PROFILER_SERVER_FTRACE_TIME_STATISTICS_PARSE_UNIT_H
#define PROFILER_SERVER_FTRACE_TIME_STATISTICS_PARSE_UNIT_H
...
class FtraceTimeStatisticsParseUnit : public AbstractParseUnit<Timeline::TextTraceDatabase> {
protected:
...
#endif // PROFILER_SERVER_FTRACE_TIME_STATISTICS_PARSE_UNIT_H
